...
```{r 2018 plot, echo=FALSE, fig.dim=c(6,4), fig.align='left', fig.cap="Ozone Level by Month in 2018"}
ozone_2018 <- subset(epa_data, year(Date) == 2018)

boxplot(Ozone ~ month(Date), 
        data = ozone_2018, 
        xlab = "Month", 
        ylab = "Ozone Level (ppb)")
```

```{r 2019 plot, echo=FALSE, fig.dim=c(6,4), fig.align='left', fig.cap="Ozone Level by Month in 2019"}
ozone_2019 <- subset(epa_data, year(Date) == 2019)
